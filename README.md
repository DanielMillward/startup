# CoolPoker
A CS 260 Project - Playing Poker
...
- For the startup I had plenty of use of the useState() hooks, more than I previously thought. For the Game component I had 10, which in retrospect could have been put into one object or something similar. Alternatively I may just be using it incorrectly, but it seems to work and I'll leave it be.

- I might have mentioned this before, but the websocket connection is separate for each client. To transfer data between, you'd have to have some way of accessing other connections. From what I've found you could do this by just storing it in a variable outside of the websocket code, but I'm experimenting with alternatives. 
